...
<form action="/employees/{{$employee->id}}" method="post" class="edit">
    ...
    <div class="mb-3">
        ...
        <select id="position" name="position" class="form-select" value="{{$employee->position}}" aria-label="Select Position">
    ...
    <div class="mb-3">
        ...
        <select id="status" name="status" class="form-select" value="{{$employee->status}}" aria-label="Select Status">
